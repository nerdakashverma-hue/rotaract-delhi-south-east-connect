...
export function WhyChooseSection() {
  return <section className="py-20 md:py-32 bg-muted/30 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 animate-slide-up">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">Why Choose RAC DSE? <span className="gradient-text">RAC DSE?</span> 💫
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          icon: Heart,
          title: "Genuine Bonds",
          desc: "Friendships that last a lifetime, not just a tenure",
          delay: 0
        }, {
          icon: Users,
          title: "Supportive Fam",
          desc: "A hype squad that lifts you up, always",
          delay: 100
        }, {
          icon: Star,
          title: "Real Impact",
          desc: "Projects that make tangible differences",
          delay: 200
        }, {
          icon: Laugh,
          title: "Fun Vibes",
          desc: "Work hard, party harder (responsibly!)",
          delay: 300
        }, {
          icon: Coffee,
          title: "Chai Breaks",
          desc: "The best ideas happen over chai and chill",
          delay: 400
        }, {
          icon: Trophy,
          title: "Growth Path",
          desc: "From shy to confident, one project at a time",
          delay: 500
          ...
          animationDelay: `${300 + item.delay}ms`
              ...
              <div className="w-14 h-14 rounded-xl gradient-bg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform animate-bounce-subtle" style={{
